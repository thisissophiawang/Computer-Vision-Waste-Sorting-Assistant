...
# sitting the font globally for all the plots
...
with gr.Blocks(
    ...
    with gr.Tabs() as tabs:
        with gr.Tab("Overall Analysis"):
            ...
            analyze_button.click(fn=analyze_waste_data, inputs=file_input, outputs=[output1, output2, output3, pie_output, bar_output])
